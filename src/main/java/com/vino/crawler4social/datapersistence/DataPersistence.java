...
public class DataPersistence {
	...
	public DataPersistence() {
		...
		InputStream in = DataPersistence.class
	...
	public static void saveFile(String path, String content) throws IOException {
		 ...
		 * 
		 * String fileName = url.substring(url.lastIndexOf("/")); String
	...
	public void saveInDatabase(String website, String time, String nickname,
			String content, String href) {
